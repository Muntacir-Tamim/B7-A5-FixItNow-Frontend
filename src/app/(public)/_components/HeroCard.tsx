  ...
  return (
    <div className="relative flex justify-center lg:justify-end mt-12 lg:mt-0">
      <div className="relative w-full max-w-[520px] aspect-[4/3.3] min-h-[420px]">
        ...
        <div
          className="absolute hover:z-60 -top-4 -left-2 sm:-top-6 sm:-left-4 bg-card border rounded-3xl p-4 shadow-2xl z-7 
                        w-[210px] sm:w-60 
          ...
          <div className="relative h-52 sm:h-56 rounded-2xl overflow-hidden mb-4">
            ...
            <div className="absolute bottom-4 left-4 text-white">
              ...
              <p className="text-sm font-medium">
                "Fixed my leaking pipe in under 2 hours!"
              </p>
        ...
        <div
          className="absolute top-16 sm:top-20 left-1/2 -translate-x-1/2 bg-card border rounded-3xl p-5 shadow-2xl z-10
                        w-56 sm:w-64 
        ...
        {/* Card 3 - Home Repair */}
        <div
          className="absolute bottom-8 sm:bottom-8 right-1 sm:right-2 bg-card border rounded-3xl p-4 shadow-2xl z-10 
                        w-[210px] sm:w-60 
        ...
        >
          <div className="relative h-52 sm:h-56 rounded-2xl overflow-hidden mb-4">
            ...
            <div className="absolute bottom-4 left-4 text-white">
              <div className="uppercase tracking-widest text-xs mb-1">
                In Progress
              </div>
        ...
        <div
          className="absolute -bottom-25 -right-4 sm:-right-6 bg-card border shadow-2xl rounded-2xl px-5 py-4 z-50 flex items-center gap-3
