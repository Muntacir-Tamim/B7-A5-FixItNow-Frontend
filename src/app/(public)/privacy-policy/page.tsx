...
const privacyHighlights = [
  {
    icon: Eye,
    title: "Transparency",
    description: "We explain what information we collect and how it is used.",
  },
  {
    icon: Lock,
    title: "Security",
          ...
          <div className="grid gap-10 lg:grid-cols-[250px_minmax(0,1fr)]">
            ...
            >
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-4 leading-7 text-muted-foreground">
                      By using FixItNow, you acknowledge that you have read and
              ...
              >
                ...
                <PolicySubheading>Information You Provide</PolicySubheading>
              ...
              <section id="information-sharing" className="mt-14 scroll-mt-24">
                <SectionHeading number="03" title="Information Sharing" />

                <PolicyParagraph>
                  We do not sell your personal information as part of the normal
                  operation of FixItNow. We may share information in limited
                  circumstances necessary to operate the Platform, provide
                  services, or comply with legal obligations.
                </PolicyParagraph>

                <PolicySubheading>Customers & Technicians</PolicySubheading>

                <PolicyParagraph>
                  When you use FixItNow to request or provide a service, certain
                  information may be visible to the other party when necessary
                  to facilitate the booking and completion of the service.
                </PolicyParagraph>
                ...
                <PolicySubheading>Legal & Safety Requirements</PolicySubheading>
              ...
              <section id="cookies" className="mt-14 scroll-mt-24">
                <SectionHeading
                  number="04"
                  title="Cookies & Similar Technologies"
                />
                ...
                >
                  ...
                  <p className="text-sm leading-6 text-muted-foreground">
                    ...
                    settings. Disabling certain cookies may affect some Platform
                    functionality.
                  </p>
                </div>
              </section>
              ...
              <section id="data-security" className="mt-14 scroll-mt-24">
              ...
              <section id="data-retention" className="mt-14 scroll-mt-24">
                <SectionHeading number="06" title="Data Retention" />
                ...
                <PolicyParagraph>
                  The length of time we retain information may vary depending on
              ...
              <section id="your-rights" className="mt-14 scroll-mt-24">
                <SectionHeading number="07" title="Your Rights & Choices" />
              ...
              <section id="third-party-services" className="mt-14 scroll-mt-24">
                <SectionHeading number="08" title="Third-Party Services" />

                <PolicyParagraph>
                  FixItNow may integrate with or rely on third-party services to
                  provide certain functionality. These services may process
                ...
                <PolicyParagraph>
                  ...
                  services before providing information directly to them.
                </PolicyParagraph>
              </section>
              ...
              <section id="children-privacy" className="mt-14 scroll-mt-24">
                ...
                <PolicyParagraph>
                  ...
                  in violation of applicable legal requirements. If you believe
                  a child has provided personal information to us, please
              ...
              <section id="policy-changes" className="mt-14 scroll-mt-24">
                <SectionHeading number="10" title="Changes to This Policy" />

                <PolicyParagraph>
                  We may update this Privacy Policy from time to time to reflect
                  changes to our services, practices, technologies, or legal
                  requirements.
                </PolicyParagraph>

                <PolicyParagraph>
                  When we make changes, we may update the effective date at the
                  beginning of this policy. Your continued use of the Platform
                  after an updated policy becomes effective means that you
                  acknowledge the revised policy to the extent permitted by
                  applicable law.
                </PolicyParagraph>
              </section>
              ...
              <section id="contact" className="mt-14 scroll-mt-24">
                ...
                <PolicyParagraph>
                  ...
                  information, or our privacy practices, please contact
                  FixItNow.
                </PolicyParagraph>
              ...
              >
                <p className="text-xs leading-6 text-muted-foreground">
                  ...
                  Privacy Policy is a general product template and is not legal
                  advice. Replace the placeholders with your actual business
                  information and have the policy reviewed by a qualified legal
                  professional to ensure it meets the requirements applicable to
                  FixItNow and the locations in which you operate.
                </p>
              </div>
            </article>
          </div>
...
function PolicyParagraph({ children }: { children: React.ReactNode }) {
  return <p className="mt-5 leading-7 text-muted-foreground">{children}</p>;
}
