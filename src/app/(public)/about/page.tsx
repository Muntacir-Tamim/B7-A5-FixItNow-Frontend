        ...
        >
          <div className="mx-auto max-w-4xl text-center">
            ...
            >
              ...
              <span className="block text-[#ff7308]">Simple & Reliable.</span>
            </motion.h1>
            ...
            >
              ...
              >
                <Link href="/find-technicians">Find Technicians</Link>
              </Button>
            </motion.div>
          </div>
        </div>
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
            ...
            >
              ...
              <p className="mt-6 leading-7 text-muted-foreground">
                ...
                FixItNow brings customers and professionals together through one
                simple platform.
              </p>
              ...
              >
                ...
                <div className="relative">
                  <div className="mb-8 flex items-center justify-between">
                    <div>
                      <p className="text-sm text-muted-foreground">FixItNow</p>

                      <p className="mt-1 text-xl font-bold">Service Journey</p>
                    </div>
        ...
        >
          ...
          >
            ...
            >
              ...
              <span className="block text-[#ff7308]">starts here.</span>
            </h2>
            ...
            >
              ...
              <Button asChild size="lg" variant="outline" className="h-12 px-7">
                <Link href="/find-technicians">Find a Technician</Link>
              </Button>
            </div>
          </motion.div>
        </div>
