      ...
      <section className="relative overflow-hidden">
        ...
        >
          ...
          <motion.p
            ...
            "
          >
            Find answers about bookings, payments, accounts, technicians, and
            everything else you need to get the most from FixItNow.
          </motion.p>
        ...
        >
          ...
          >
            ...
            >
              ...
              <p className="mt-4 font-semibold">All Help</p>
            ...
            {categories.map((category) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="mt-4 font-semibold">{category.title}</p>
        ...
        >
          <div className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
              Browse the most common questions from FixItNow customers and
              technicians.
            </p>
          </div>
              ...
              filteredFAQs.map((faq) => {
                ...
                return (
                  <FAQItem
                    ...
                    onToggle={() =>
                      setOpenFAQ(
                        openFAQ === originalIndex ? null : originalIndex,
                      )
                    }
                  />
                );
              ...
              <Card className="border-dashed">
                <CardContent className="flex flex-col items-center justify-center px-6 py-14 text-center">
                  ...
                  <p className="mt-2 max-w-md text-sm text-muted-foreground">
                    We couldn't find a matching answer. Try a different search
            ...
            >
              <Card className="h-full">
                <CardHeader>
                  ...
                  <CardTitle className="pt-2">Booking Help</CardTitle>
                </CardHeader>

                <CardContent>
                  <p className="text-sm leading-6 text-muted-foreground">
                    Need help finding a service, choosing a technician, or
            ...
            >
              <Card className="h-full">
                <CardHeader>
                  ...
                  <CardTitle className="pt-2">Technician Help</CardTitle>
                </CardHeader>

                <CardContent>
                  <p className="text-sm leading-6 text-muted-foreground">
                    Learn how to create your profile, manage availability, and
            ...
            >
              <Card className="h-full">
                <CardHeader>
                  ...
                  <CardTitle className="pt-2">Account & Security</CardTitle>
                </CardHeader>

                <CardContent>
                  <p className="text-sm leading-6 text-muted-foreground">
                    Get help with your account, profile, login, and general
                    security questions.
                  </p>
